...
emotion_model_path = 'models/MPNetbyAdri.hdf5'
...
img_raw = cv2.imread("1.jpg", cv2.IMREAD_COLOR)
numframes = 1
...
if __name__ == '__main__':
    ...
    #while 1:
        ...
        for b in dets:
            ...
            if label == 'Male':
                cv2.rectangle(img_raw, (fX, fY), (fW, fH),(0, 128, 0), 2)
            else:
                cv2.rectangle(img_raw, (fX, fY), (fW, fH),(100, 0, 200), 2)
            ...
            for nf in range(10):
                if num_face == nf:
                    cv2.imshow("ROI-{}".format(num_face), roi_ori)
